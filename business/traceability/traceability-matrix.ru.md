...
<p align="center"><a href="traceability-matrix.md">English</a> · <a href="traceability-matrix.ru.md"><b>Русский</b></a></p>

> Связывает business rules, requirements, acceptance, quality expectations и real technical ownership.
...
|---|---|
| Offline / access consistency | `frontend/access/`, `frontend/offline/`, `backend/access/`, `system/review/failure-scenarios.ru.md` |
...
| Reliability / recovery | `system/review/failure-scenarios.ru.md`, component tests |
| Performance | future calibrated measurements; см. closure register |
| Release readiness | `system/review/release-readiness.ru.md` |
| Testability | `frontend/testing/` + backend/integration evidence |

Standalone `operations/` owner в current Aveli baseline отсутствует.

## Coverage Result

Все current functional areas имеют business/requirement → acceptance → technical-owner path. Remaining work explicitly classified в closure register.
