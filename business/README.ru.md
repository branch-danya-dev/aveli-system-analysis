...
> Бизнес-документация Aveli: контекст продукта, scope, требования, процессы, постановки задач и traceability.
...
- постановок задач на реализацию;
- критериев приемки;
...
Директория разделена на отдельные области для контекста, scope, требований, процессов, задач и traceability.
...
| `tasks/` | Постановки задач, сформированные на основе согласованных аналитических решений. |
| `traceability/` | Связи между бизнес-правилами, требованиями, задачами, реализацией и проверкой. |
